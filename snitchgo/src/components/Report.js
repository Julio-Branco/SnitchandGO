...
export default function Report(props) {
    ...
    return (
        <>
            <div className="card rounded" style={{ 'boxShadow': 'rgba(0, 0, 0, 0.35) 0px 5px 45px', 'display': display }}>
                <div className="card-body" style={{ "boxShadow": 'rgba(0, 0, 0, 0.35) 0px 5px 45px' }}>
                    ...
                    <div className="d-flex flex-row justify-content-around p-2 rounded">
                        ...
                        <button className="second-btn" id="dismiss" onClick={handleDismiss} data-bs-toggle="tooltip" data-bs-title="Retirer l'accusation">
